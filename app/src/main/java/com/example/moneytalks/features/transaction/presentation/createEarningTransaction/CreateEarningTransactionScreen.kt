...
fun CreateEarningTransactionScreen(
    viewModel: CreateEarningTransactionViewModel = hiltViewModel(),
    navigateBack: () -> Unit
) {
    ...
    Scaffold(
        ...
        when (val state = uiState) {
            ...
            is CreateEarningTransactionUiState.Data -> {
                Column(
                        ...
                        ExposedDropdownMenu(
                            ...
                            state.accounts.forEach { account ->
                                DropdownMenuItem(
                                    ...
                                    onClick = {
                                        viewModel.handleIntent(CreateEarningTransactionIntent.SetAccount(account.id))
                        ...
                        ExposedDropdownMenu(
                            ...
                            state.categories.forEach { category ->
                                DropdownMenuItem(
                                    ...
                                    onClick = {
                                        viewModel.handleIntent(CreateEarningTransactionIntent.SetCategory(category.id))
                    ...
                    if (showAmountDialog) {
                        AlertDialog(
                            ...
                            confirmButton = {
                                Button(onClick = {
                                    viewModel.handleIntent(CreateEarningTransactionIntent.SetAmount(amountText))
                                ...
                                Button(onClick = {
                                    datePickerState.selectedDateMillis?.let { ms ->
                                        val localDate = Instant.ofEpochMilli(ms)
                                            ...
                                            .toLocalDate()
                                        viewModel.handleIntent(CreateEarningTransactionIntent.SetDate(localDate.toString()))
                                    }
                                ...
                                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                                    ...
                                    Row(
                                        ...
                                        TextButton(onClick = {
                                            ...
                                            viewModel.handleIntent(CreateEarningTransactionIntent.SetTime(timeStr))
                    ...
                    if (showCommentDialog) {
                        AlertDialog(
                            ...
                            confirmButton = {
                                Button(onClick = {
                                    viewModel.handleIntent(CreateEarningTransactionIntent.SetComment(commentText))
            ...
            is CreateEarningTransactionUiState.Error -> {
                Box(Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        Text(
                            text = state.message,
            ...
            is CreateEarningTransactionUiState.Success -> {
                navigateBack
                viewModel.reset()
            }
        }
