...
object Routes {
    const val EXPENSES_GRAPH = "расходы_граф"
    const val EARNINGS_GRAPH = "доходы_граф"
    const val ACCOUNTS_GRAPH = "счет_граф"
    const val CATEGORIES_GRAPH = "статьи_граф"
    const val SETTINGS_GRAPH = "настройки_граф"
    ...
    const val ACCOUNT_ADD = "счет_добавить"
    const val ACCOUNT_EDIT = "счет_редактировать"
